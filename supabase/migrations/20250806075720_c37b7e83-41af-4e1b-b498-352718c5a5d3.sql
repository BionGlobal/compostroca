-- Corrigir avisos de segurança - remover políticas dependentes e recriar funções

-- Remover políticas que dependem das funções
DROP POLICY IF EXISTS "Super admins can view all profiles" ON public.profiles;
DROP POLICY IF EXISTS "Super admins can update user status and roles" ON public.profiles;
...
-- Recriar as políticas usando as funções corrigidas
