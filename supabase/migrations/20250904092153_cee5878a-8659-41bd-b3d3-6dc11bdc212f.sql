-- Corrigir migração anterior - buscar lote por código ao invés de converter para UUID
-- Limpar dados inseridos incorretamente
DELETE FROM public.lote_fotos;

-- Migrar dados existentes da entrega_fotos para lote_fotos (corrigido)
...
-- Migrar fotos de manejo_semanal para lote_fotos (já estava correto)
