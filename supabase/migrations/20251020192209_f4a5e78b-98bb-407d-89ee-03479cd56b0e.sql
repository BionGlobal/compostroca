...
DROP POLICY IF EXISTS "Permitir leitura pública" ON public.leituras_diarias_sensores;
DROP POLICY IF EXISTS "Permitir inserção via service key" ON public.leituras_diarias_sensores;
DROP POLICY IF EXISTS "Permitir atualização via service key" ON public.leituras_diarias_sensores;
DROP POLICY IF EXISTS "Permitir deleção via service key" ON public.leituras_diarias_sensores;
...
-- Drop políticas existentes para recriar
DROP POLICY IF EXISTS "Permitir leitura pública" ON public.medias_sensores_lote;
DROP POLICY IF EXISTS "Permitir escrita via service key" ON public.medias_sensores_lote;
